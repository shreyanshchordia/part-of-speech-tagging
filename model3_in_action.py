...
model = load_model('pre_trained_models/model3.h5',custom_objects={'ignore_accuracy': M.ignore_class_accuracy(9)})

while(1):
    print("\nType a sentence!")
    string = input()
    print(M.predict_v2(model,string,MAX_LENGTH,embedder,id2tag))
